        ...
        <>
            ...
            <div className="container1">
                ...
                <ProfilePage firstName={firstName} top={"90px"}></ProfilePage>
                    ...
                    <h1 className='d-flex justify-content-center align-items-center  ' style={{ alignContent: 'center' ,marginTop: '-100px'  }}>
                        Edit Profile
                        </h1>
                                        ...
                                        <div className='content   ' style={{ marginTop: '50px'  }}>  {/*inner data box */}
                                            <form action='/'>
                                                ...
                                                <div className=' d-flex justify-content-center  '  >
                                                    {/*Div for ur name */}
                                                 <button className='btn btn-dark col-6'  onClick={submitHandler}> Submit </button>

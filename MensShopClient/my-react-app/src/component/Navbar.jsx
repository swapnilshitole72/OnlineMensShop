...
export default function Navbar() {
  const location = useLocation();
    ...
    return (
        <div>
            <nav className="navbar navbar-expand-lg  navbar-light bg-light bg-white py-3 shadow-sm fixed-top" style={{ zIndex: 100 }} >
                <div className="container-fluid">

                    {/* fs-4 fs-1 fs-3 hyane font increase decrease karta yeto */}
                    <a className="navbar-brand fw-bold fs-2 " href="/" style={{ marginLeft: '50px' }}>
